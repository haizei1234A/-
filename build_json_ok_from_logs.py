# -*- coding: utf-8 -*-
"""
build_json_ok_from_logs.py  —  对齐 §2.2 的 JSON/合规护栏评分器
...
def main():
    ...
    ap.add_argument("--log", required=True, nargs="+",
                    help=r"一个或多个日志 glob，例如 runs\gateway_*.jsonl runs\baseline_*.jsonl")
    ...
    # 可选 Schema 校验器
    validator, schema_version = make_validator(args.schema) if args.schema else (None, None)
